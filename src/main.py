...
parser.add_argument("--epochs",   type=int, default=30,  help="CTGAN-Epochen") #50
...
for seed in args.seeds:
    ...
    for i, (name, gen_fn) in enumerate(REGISTRY.items(), 2):
        ...
        if name == "GReaT":
            gen_kwargs["epochs"] = min(args.epochs, 5)
            gen_kwargs["max_rows"] = 300
            gen_kwargs["fast_mode"] = True
